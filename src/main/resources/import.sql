...
INSERT INTO `reimburse`.`login` (`id`, `created_date`, `email`, `password`, `id_role`) VALUES ('45805945-3743-48f3-84b2-4afcc6a9ed9b', '2021-12-5', 'sch@gmail.com', 'sch', '4');
...
INSERT INTO admin (id,created_date,name,id_login) VALUES ('58b184ed-b256-4762-92cd-0c67206e0548','2021-03-14','sch','45805945-3743-48f3-84b2-4afcc6a9ed9b');
